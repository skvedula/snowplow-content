...
./snowplow-emr-etl-runner --config ${RUNNER_CONFIG} --resolver ${RUNNER_RESOLVER} --enrichments ${RUNNER_ENRICHMENTS}
...
./snowplow-storage-loader --config ${RUNNER_CONFIG} --skip analyze --include vacuum
...
./sql-runner -playbook ./playbook/public/deduplicate.yml -sqlroot /home/ec2-user/sql