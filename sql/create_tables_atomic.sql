...
--atomic.com_nordstrom_real_estate_1
...
ALTER TABLE atomic.com_nordstrom_real_estate_1 owner to storageloader;
...
ALTER TABLE atomic.com_nordstrom_uids_1 owner to storageloader;
