-- 01-11-copy-com-snowplowanalytics-snowplow-remove-from-cart.sql
-- Version: 0.1
--
...
INSERT INTO ato5180.com_snowplowanalytics_snowplow_remove_from_cart (
    ...
    SELECT schema_vendor,
       ...
       quantity,
       currency
FROM atomic.com_snowplowanalytics_snowplow_remove_from_cart_1
