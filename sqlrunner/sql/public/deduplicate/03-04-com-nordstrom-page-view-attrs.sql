...
--
-- To run these queries replace 'com_nordstrom_page_view_attrs' with the actual table name in public. If step (d) is
-- used the same table needs to be created in duplicates.

DROP TABLE IF EXISTS duplicates.tmp_com_nordstrom_page_view_attrs; -- todo: replace placeholder name
DROP TABLE IF EXISTS duplicates.tmp_com_nordstrom_page_view_attrs_id; -- todo: replace placeholder name
DROP TABLE IF EXISTS duplicates.tmp_com_nordstrom_page_view_attrs_id_remaining; -- todo: replace placeholder name
...
CREATE TABLE duplicates.tmp_com_nordstrom_page_view_attrs -- todo: replace placeholder name
  DISTKEY (root_id)
  SORTKEY (root_id)
AS (
